{{-- resources/views/dashboard/temas/edit.blade.php --}}
<x-dashboard-layout>
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
        ...
        <div class="bg-white shadow rounded-xl p-6">
            <form action="{{ route('temas.update', $tema->idTema) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <x-text-input id="nombre_tema" name="nombre_tema" type="text" class="mt-1 block w-full" 
                            value="{{ old('nombre_tema', $tema->nombre_tema) }}" required />
                    ...
                    <div>
                        ...
                        >
                            ...
                            @foreach($cursos as $curso)
                                ...
                                {{ old('curso_id', $tema->curso_id) == $curso->idCurso ? 'selected' : '' }}>
                                {{ $curso->nombre_curso }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div>
                        ...
                        >
                            ...
                            @foreach($puestos as $puesto)
                                ...
                                {{ old('puesto_id', $tema->puesto_id) == $puesto->idPuesto ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        >
                            ...
                            @foreach($departamentos as $departamento)
                                ...
                                {{ old('departamento_id', $tema->departamento_id) == $departamento->idDepartamento ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <x-text-input id="tema_url" name="tema_url" type="text" class="mt-1 block w-full" 
                            value="{{ old('tema_url', $tema->tema_url) }}"/>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="descripcion_tema" name="descripcion_tema" rows="4" 
                            ...
                            required 
                            >{{ old('descripcion_tema', $tema->descripcion_tema) }}</textarea>
