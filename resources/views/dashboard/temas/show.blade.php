{{-- resources/views/dashboard/temas/show.blade.php --}}
<x-dashboard-layout>
        ...
        <div class="bg-white shadow rounded-xl p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    <h2 class="text-2xl font-bold text-gray-900 mb-4">{{ $tema->nombre_tema }}</h2>
                </div>
                ...
                <div>
                    ...
                    <p class="text-gray-600">{{ $tema->curso->nombre_curso ? $tema->curso->nombre_curso : 'Sin Curso Asignado' }}</p>
                </div>

                <!-- Puesto -->
                <div>
                    <h3 class="text-lg font-semibold text-gray-700 mb-2">Puesto</h3>
                    <p class="text-gray-600 whitespace-pre-wrap">{{ $tema->puesto->nombre_puesto }}</p>
                </div>

                <!-- Departamento -->
                <div>
                    <h3 class="text-lg font-semibold text-gray-700 mb-2">Departamento</h3>
                    <p class="text-gray-600 whitespace-pre-wrap">{{ $tema->departamento->nombre_departamento }}</p>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="bg-gray-50 p-4 rounded-lg">
                            ...
                            <p class="text-gray-600">{{ $tema->idTema }}</p>
                        </div>
                        <div class="bg-gray-50 p-4 rounded-lg">
                            <h4 class="font-medium text-gray-700">Descripcion</h4>
                            <p class="text-gray-600">{{ $tema->descripcion_tema ?? 'No asignado' }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex items-center justify-end mt-8 gap-4 pt-6 border-t border-gray-200">
                <form action="{{ route('temas.destroy', $tema->idTema) }}" method="POST" class="inline" 
